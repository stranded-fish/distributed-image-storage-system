package cn.yulan.upload.module;
...
//                List<byte[]> values = rocksDB.multiGet(keys);
...
//                }
                ...
                System.out.println(new String(rocksDB.get("SecondKey".getBytes())));

                System.out.println("bbbb");
                System.out.println(rocksDB.keyMayExist(key,new StringBuffer()));
                System.out.println(rocksDB.keyMayExist("SecondKey".getBytes(),new StringBuffer()));
